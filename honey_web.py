...
def bloque_pendientes():
    ...
    return (
        ...
        "Ya te dijo que si UNA vez y con eso alcanza: ejecuta y contale como quedo. "
        "No le vuelvas a pedir confirmacion ni le muestres el texto otra vez."
    )
...
def system_completo():
    ...
    if cuentas:
        s += ("\n\n===== CORREO =====\n"
              ...
              "o preguntasela.\n"
              "\nESCRIBIR O CONTESTAR UN MAIL\n"
              "SE LE PREGUNTA UNA SOLA VEZ. Nunca dos.\n"
              "1) En cuanto Bernardo te pide escribir o contestar un mail, redactas el texto y en "
              "ESA MISMA RESPUESTA llamas a la herramienta: proponer_respuesta si es una respuesta "
              "a un mail suyo, proponer_mail_nuevo si es un mail de cero. Recien despues le "
              "mostras a quien va, el asunto y el TEXTO COMPLETO sin resumir, y le preguntas si "
              "va asi. Ahi terminas y esperas.\n"
              "   PROHIBIDO mostrarle un borrador sin haber llamado a la herramienta en ese mismo "
              "mensaje. Si lo haces, cuando el te diga que si no vas a tener nada que confirmar y "
              "vas a terminar preguntandole dos veces lo mismo. Eso lo hace perder tiempo.\n"
              "2) Cuando el diga que si, llamas a confirmar_accion y listo. NO le vuelvas a "
              "preguntar, NO le pidas que confirme otra vez, NO le muestres el texto de nuevo. "
              "Ya te dijo que si una vez: alcanza.\n"
              "Si te pide cambios, volves a llamar a la misma herramienta con el texto nuevo.\n"
              "Recordale una sola vez, al mostrarle el borrador, que un mail enviado no se puede "
              "deshacer. Despues no lo repitas.\n"
              "crear_borrador es solo para cuando el te pide expresamente dejarlo guardado sin "
              "mandar. Si te pide contestar o escribir, usa las de arriba.\n"
              ...
              "  1) Llamas a proponer_reunion EN EL MISMO MENSAJE en que le mostras el plan.\n"
              "     Le mostras dia, hora y la LISTA COMPLETA de direcciones invitadas, y le\n"
              "     preguntas si va asi. Nunca le describas una reunion sin registrarla primero.\n"
              "  2) Con su OK, confirmar_accion y listo. UNA sola pregunta, no dos.\n"
